    ...
    <div className="flex flex-col min-h-screen bg-[#fafcfa]">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                <p className="text-lg text-gray-500 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                  ...
                  business growth. Complete tasks to earn or launch campaigns to
                  reach thousands of verified users.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      "w-full sm:w-auto h-14 px-8 text-base border-gray-200 text-gray-700 hover:bg-gray-50 rounded-xl",
                    )}
                  >
                    How it works
                  </Link>
                ...
                <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-4 sm:p-6 z-20 lg:translate-x-4">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm font-bold text-[#2faf2f]">
                        +₦6,843
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-8 bg-transparent">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { value: "3K+", label: "Verified Users" },
              { value: "2000+", label: "Active Campaigns" },
              { value: "1250+", label: "Tasks Completed" },
              { value: "₦1.52M+", label: "Rewards Distributed" },
            ].map((stat, idx) => (
              <div
                key={idx}
                className="bg-white py-8 px-4 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col items-center justify-center"
              >
                <div className="text-2xl font-bold text-[#2faf2f] mb-1">
                  {stat.value}
                </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base">
              Discover the powerful tools designed to simplify digital tasks and
              maximize business reach in one seamless interface.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Sign up in seconds and verify your profile to unlock all features.",
              },
              {
                num: "02",
                title: "Explore Opportunities",
                desc: "Browse available tasks or set up your first business campaign.",
              },
              {
                num: "03",
                title: "Complete Tasks",
                desc: "Submit proof of completion and watch your earnings grow automatically.",
              },
              {
                num: "04",
                title: "Track Growth",
                desc: "Withdraw rewards or analyze campaign data through your dashboard.",
              },
            ].map((step, idx) => (
              <div
                key={idx}
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 mb-32">
            <div className="flex-1 w-full">
              <div className="w-full aspect-video rounded-3xl overflow-hidden shadow-2xl relative border border-gray-200 bg-white">
                <Image
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Trusted",
                desc: "Verified by thousands of active users and businesses worldwide.",
              },
              {
                title: "Fast",
                desc: "Instant task verification and rapid payment withdrawals.",
              },
              {
                title: "Simple",
                desc: "Intuitively designed for ease of use across all devices.",
              },
              {
                title: "Secure",
                desc: "Advanced security protocols protect your data and earnings.",
              },
              {
                title: "Powerful",
                desc: "Tools that scale with your growth, from micro-tasks to enterprise ads.",
              },
              {
                title: "Community",
                desc: "A vibrant ecosystem of professionals helping each other grow.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="bg-[#3e4141] p-8 rounded-2xl border border-white/5 hover:bg-[#464949] transition-colors"
              >
      ...
      <section className="py-24 bg-[#fafcfa] overflow-hidden">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-16">
            The Future of Digital Opportunity
          </h2>
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center text-[#2faf2f]">
