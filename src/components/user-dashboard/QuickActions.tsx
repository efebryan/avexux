...
export function QuickActions() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
      {/* Explore New Tasks */}
      <button className="group relative overflow-hidden bg-[#0f8538] rounded-2xl p-6 text-left transition-transform hover:-translate-y-1 hover:shadow-lg shadow-md flex items-center justify-between">
      ...
      {/* Withdraw Cash Out */}
      <button className="group relative overflow-hidden bg-[#1f2328] rounded-2xl p-6 text-left transition-transform hover:-translate-y-1 hover:shadow-lg shadow-md flex items-center justify-between border border-[#2d3136]">
        <div className="relative z-10 text-white">
      ...
      {/* Affiliate Copy Link */}
      <button className="group relative overflow-hidden bg-gray-200/80 rounded-2xl p-6 text-left transition-transform hover:-translate-y-1 hover:shadow-lg shadow-sm flex items-center justify-between border border-gray-300">
